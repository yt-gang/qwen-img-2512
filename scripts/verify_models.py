#!/usr/bin/env python3
"""Seed and verify the immutable model set on a RunPod Network Volume."""
...
def main() -> int:
    ...
    parser.add_argument("--full", action="store_true", help="calculate SHA-256 and write the verified marker")
